...
BoostedSweepTriangleSearch::BoostedSweepTriangleSearch(
    ...
    for (const shared_ptr<Evaluator> &pref_eval : preferred_evals) {
        ...
        if (source == -1) {
            cerr << "BoostedSweepTriangleSearch: every preferred_evals entry "
...
void BoostedSweepTriangleSearch::cache_preferred_operators(
...
int BoostedSweepTriangleSearch::select_available_served(
