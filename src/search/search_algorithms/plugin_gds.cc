...
class GraphDiscrepancySearchFeature
    : public plugins::TypedFeature<SearchAlgorithm, graph_discrepancy_search::GraphDiscrepancySearch> {
public:
    GraphDiscrepancySearchFeature() : TypedFeature("gds") {
        ...
        add_option<shared_ptr<Evaluator>>("eval", "discrepancy ranking evaluator");
    ...
    virtual shared_ptr<graph_discrepancy_search::GraphDiscrepancySearch> create_component(
        const plugins::Options &opts) const override {
        return plugins::make_shared_from_arg_tuples<graph_discrepancy_search::GraphDiscrepancySearch>(
...
public:
    GraphDiscrepancySearchAliasFeature() : TypedFeature("graph_discrepancy") {
        ...
        add_option<bool>("anytime", "continue after finding a solution", "true");
        add_option<string>("discrepancy_mode", "discrepancy definition", "\"binary\"");
        add_search_pruning_options_to_feature(*this);
